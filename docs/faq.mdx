...
<AccordionGroup>
  <Accordion title="What's the difference between Playground and Wallet mode?">
    ...
    **Wallet mode**: Mainnet deployment with your own wallet (HOT or Meteor). Uses real NEAR tokens.
  </Accordion>

  <Accordion title="Can I deploy to testnet with my wallet?">
    No. External wallets (HOT, Meteor) only support mainnet. For testnet, use Playground mode - it's free and has the same functionality.
  </Accordion>
