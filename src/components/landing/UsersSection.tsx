...
const USER_TYPES = [
  {
    ...
    benefits: [
      ...
      },
      {
        ...
        description: 'Built-in NEAR testnet accounts for seamless deployment.',
      },
      {
        icon: Share2,
  ...
  },
  {
    id: 'newbies',
    icon: GraduationCap,
    title: 'NEAR Beginners',
    description: 'Start your NEAR journey with a guided, hassle-free experience.',
    benefits: [
      {
        icon: BookOpen,
  ...
  },
  {
    ...
    description: 'Streamlined environment for efficient NEAR development.',
    benefits: [
      {
        icon: Rocket,
