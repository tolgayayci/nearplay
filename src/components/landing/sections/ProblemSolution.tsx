  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 15; i++) {
      lines.push({
        ...
        color: i % 2 === 0 ? '239, 68, 68' : '0, 192, 139' // red vs teal (NEAR color)
      });
    }
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="max-w-3xl mb-20">
          ...
          <p className="text-xl text-gray-500 font-light">
            Traditional setup: 30 minutes. NEAR Playground: 30 seconds. The math is simple.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-32 transition-all duration-700 hover:gap-20">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-500">You have a brilliant idea for a NEAR smart contract</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300 delay-75">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-500">Installing Rust, near-cli, cargo-near...</div>
                </div>
              </div>
          ...
          <div>
            <div className="mb-8">
              <div className="text-sm font-medium text-teal-600 uppercase tracking-wider mb-2">After</div>
              <h3 className="text-3xl font-semibold text-gray-900">NEAR Playground</h3>
            </div>

            <div className="space-y-6">
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300">
                <div className="text-2xl font-light text-teal-600 w-12 animate-pulse">0s</div>
                <div className="flex-1">
                  <div className="font-medium text-gray-900">Open browser</div>
                  <div className="text-gray-500">Visit nearplay.app</div>
                </div>
              </div>

              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300 delay-75">
                <div className="text-2xl font-light text-teal-600 w-12">10s</div>
                <div className="flex-1">
              ...
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300 delay-100">
                <div className="text-2xl font-light text-teal-600 w-12">20s</div>
                <div className="flex-1">
                  <div className="font-medium text-gray-900">Compile & test</div>
                  <div className="text-gray-500">One-click compilation with cargo-near</div>
                </div>
              </div>

              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300 delay-150">
                <div className="text-2xl font-light text-teal-600 w-12">30s</div>
                <div className="flex-1">
                  <div className="font-medium text-gray-900">Deploy live</div>
                  <div className="text-gray-500">Your contract is on NEAR testnet</div>
                </div>
              </div>
            </div>
