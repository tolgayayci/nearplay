...
const RESOURCES = [
  {
    ...
    description: "Writing Your First NEAR Contract in Rust",
  ...
  },
  {
    ...
    description: "NEAR Protocol Documentation & SDK Reference",
  ...
  },
  {
    ...
    description: "Join the NEAR Developer Discord Community",
    href: "https://discord.gg/UY9Xf2k",
    ...
    <section className="container mx-auto py-24 lg:py-32">
      ...
      >
        ...
        <p className="text-lg text-muted-foreground">
          Everything you need to get started with NEAR development
        </p>
      </motion.div>
