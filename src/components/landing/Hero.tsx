      ...
      <div className="container mx-auto py-24 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            className="space-y-8"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/5 border border-emerald-500/20 text-sm">
              <Badge variant="outline" className="bg-emerald-500/10 text-emerald-600 border-emerald-500/20">
                NEAR Testnet
              </Badge>
              <span className={cn(
                "text-emerald-600 font-bold tracking-tight",
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight">
                ...
                <span className="block mt-2 bg-gradient-to-r from-emerald-500 to-blue-500 text-transparent bg-clip-text">
                  on NEAR Protocol
                </span>
              </h1>
              <p className="text-xl text-muted-foreground max-w-xl">
                Write, compile, and deploy Rust contracts to NEAR testnet.
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-500 via-blue-500 to-purple-500 opacity-90 transition-opacity group-hover:opacity-100" />
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm">
                ...
                <span className="text-muted-foreground">building on NEAR</span>
              </div>
            </div>
          </motion.div>
